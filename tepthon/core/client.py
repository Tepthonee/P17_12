        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    tepthon.add_event_handler(func, events.MessageEdited(**kwargs))
                tepthon.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                tepthon.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                tepthon.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
