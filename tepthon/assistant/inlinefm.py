...
from tepthon.helpers.utils import _jmthonutils
...
# رجوع
@tepthon.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# فوك
@tepthon.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# تحت
@tepthon.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
@tepthon.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# الحذف
@tepthon.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# الارسال
@tepthon.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# الكص
@tepthon.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# نسخ
@tepthon.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@tepthon.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
