...
from . import edit_delete, edit_or_reply, mention, tepthon
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m tepthon`",
        "**State changed from starting to up**",
        "__INFO:tepthon:Logged in as 557667062__",
        "__INFO:tepthon:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@tepthon.on(admin_cmd(pattern="احبك"))
async def rz(tepthon):
    roz = random.choice(love)
    return await edit_or_reply(tepthon, roz)
