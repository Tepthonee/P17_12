...
@tepthon.ar_cmd(pattern="كرر ([\s\S]*)")
...
@tepthon.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@tepthon.ar_cmd(pattern="تعبير مكرر$")
...
@tepthon.ar_cmd(pattern="ايقاف التكرار ?(.*)")
