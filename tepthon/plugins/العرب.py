...
@tepthon.on(admin_cmd(pattern="(تجميع العرب|تجميع عرب)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await tepthon.send_message('@xnsex21bot', '/start')
        await asyncio.sleep(5)
        msg0 = await tepthon.get_messages('@xnsex21bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await tepthon.get_messages('@xnsex21bot', limit=1)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await tepthon.send_message(event.chat_id, f"**لاتوجد قنوات للبوت**")
                break
            ...
            try:
                ...
                msg2 = await tepthon.get_messages('@xnsex21bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await tepthon.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
