...
@tepthon.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular tepthon",
    },
)
...
@tepthon.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي تيبثون الاصلي",
    },
)
async def nekobot(cat):
...
@tepthon.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Cattepthon is One of the Popular tepthon",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@tepthon.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular tepthon",
    },
)
async def nekobot(cat):
...
@tepthon.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular tepthon",
    },
)
async def nekobot(cat):
