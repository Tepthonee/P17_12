...
from tepthon.plugins import ALIVE_NAME, BOTLOG, BOTLOG_CHATID, tepthon, edit_delete, get_user_from_event
...
@tepthon.ar_cmd(pattern="انتحال(?:\s|$)([\s\S]*)")
async def _(event):
...
@tepthon.ar_cmd(pattern=f"{ANT7AL}$")
