...
from . import edit_delete, edit_or_reply, progress, tepthon
...
@tepthon.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@tepthon.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@tepthon.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@tepthon.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
