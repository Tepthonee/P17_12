...
@tepthon.ar_cmd(pattern="كتم(?:\s|$)([\s\S]*)")
...
@tepthon.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@tepthon.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
