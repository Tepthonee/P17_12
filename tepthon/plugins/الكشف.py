...
from tepthon.core.managers import edit_or_reply, edit_delete
from tepthon.helpers import reply_id
from tepthon.sql_helper.globals import gvarstatus
from tepthon.plugins import spamwatch
...
@tepthon.ar_cmd(pattern="رابط الحساب(?:\s|$)([\s\S]*)")
